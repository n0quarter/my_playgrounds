...
class RestApiService {
  ...
  func getBrochuresParent(jsonString: String) -> [iRestApiModel] {
    return parser.parseJson(json: jsonString)
  }
}
...
publisherService.getBrochuresParent(jsonString: "kinda_json_string")


//// use via specific subclass
let brochureService = brochureRestApiService()
let brochures1 = brochureService.getBrochuresParent(jsonString: "kinda_json_string")
